...
블랙아웃 날짜는 IBM에서 승인해야 하며, 승인을 받는 데 걸리는 시간은 경우에 따라 다릅니다. 요청한 블랙아웃 날짜가 승인되면 IBM에서 사용 불가능 기간 동안 현재 스케줄링된 기존 업데이트를 모두 취소합니다. IBM에서는 이러한 업데이트에 대한 새 레코드를 작성한 다음 승인된 블랙아웃 날짜를 제외한 날짜로 스케줄링합니다.
