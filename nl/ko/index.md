...
수퍼유저 권한(`ops.admin`)이 있는 경우, **관리 &gt; 시스템 정보 &gt; * 보류 중 수***를 클릭하여 **시스템 업데이트** 페이지에 액세스해서 스케줄되고 보류 중인 유지보수 업데이트를 볼 수 있습니다. 환경의 모든 사용자는 **지원** &gt; **상태**를 클릭하여 시스템을 중단하는 스케줄된 유지보수 업데이트 이벤트를 볼 수 있습니다. 
